...
export const buttonAvatar = document.querySelector('.profile__img-wraper');
...
export const userAvatar = document.querySelector('.profile__img');

export const popupAvatar = document.querySelector('.popup_type_update-avatar');
export const popupProfile = document.querySelector('.popup_type_profile');
export const popupPhoto = document.querySelector('.popup_type_photo');
export const popupCardDelete = document.querySelector('.popup_type_card-delete');
